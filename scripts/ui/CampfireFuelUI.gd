...
func create_ui() -> void:
	...
	# Apply wasteland theme colors
	var style_box = StyleBoxFlat.new()
	style_box.bg_color = Color(0.12, 0.10, 0.08, 0.95)  # Dark leather
	style_box.border_color = Color(0.45, 0.30, 0.18, 1.0)  # Rusted bronze
...
func create_button(text: String) -> Button:
	...
	style_normal.bg_color = Color(0.45, 0.30, 0.18, 0.8)
	style_normal.border_color = Color(0.65, 0.50, 0.30, 1.0)
	...
	style_hover.bg_color = Color(0.55, 0.40, 0.28, 0.9)
