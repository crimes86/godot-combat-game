...
> **Scope**: This document covers the **game world database** (SQLite) for player data, world state, and persistence. For the Ashbane achievement/NFT backend, see [API_CONTRACT.md](API_CONTRACT.md).
