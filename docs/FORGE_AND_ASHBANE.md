...
|------|-------------|-----------------|
| **Guest** | No Ashbane account, just wants to try the game | "Jump right in, see what it's about" |
| **New Player** | Has Ashbane account, no providers linked | "Your journey starts here" |
...
- Ashbane Card: Shows "Initiate" tier
...
- [ ] Authenticated mode (shows Ashbane card)
