...
## Appendix: Asset Acquisition Checklist

This checklist tracks assets to download from the [LPC Generator](https://liberatedpixelcup.github.io/Universal-LPC-Spritesheet-Character-Generator/).

After downloading each spritesheet, run:
```bash
